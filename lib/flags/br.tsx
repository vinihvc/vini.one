...
export const BrFlag = createIcon({
  ...
  path: (
    <>
      <path d="M0 0h512v512H0z" fill="#6DA544" />
      <path d="M256 100.2 467.5 256 256 411.8 44.5 256z" fill="#FFDA44" />
      <path d="M256 345a89 89 0 1 0 0-178 89 89 0 0 0 0 178" fill="#EEE" />
      <path
        clipRule="evenodd"
