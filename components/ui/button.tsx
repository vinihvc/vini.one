...
export const buttonStyle = tv({
  ...
  variants: {
    variant: {
      solid:
        "bg-foreground/5 font-medium text-muted-foreground ring-foreground/30 hover:bg-foreground/10 hover:text-foreground focus-visible:text-foreground",
      primary: "bg-blue-500 text-white ring-blue-500/50 hover:bg-blue-500/90",
