    ...
    <>
      <div
        ...
        className={cn(
          ...
          "opacity-64",
          "pointer-events-none",
          "mask-[radial-gradient(circle_at_50%_0%,white_0%,transparent_64%)]",
      ...
      <svg
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 isolate -z-1 h-full min-h-screen w-full opacity-5"
      >
        <filter id="noise">
          <feTurbulence
            baseFrequency="0.80"
