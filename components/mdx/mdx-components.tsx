...
export const mdxComponents: MDXComponentsType = {
  ...
  a: ({ href, ...props }: React.ComponentProps<"a">) => {
    if (href?.startsWith("/")) {
      return <Link className={linkClasses} href={href} {...props} />;
    }

    if (href?.startsWith("#")) {
      return <a className={linkClasses} href={href} {...props} />;
    }
...
interface MDXBodyProps {
  Body: React.ComponentType<{ components?: MDXComponentsType }>;
  components?: MDXComponentsType;
}

export function MDXBody({ Body, components }: MDXBodyProps) {
  return <Body components={{ ...mdxComponents, ...components }} />;
}
